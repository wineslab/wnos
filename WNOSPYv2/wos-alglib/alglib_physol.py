...
#------------------------------------------------------
# Code Date: 2017-12-18 15:19:57.998234
#######################################################
...
def func(opt_var, sign=-1.0):
	return sign*1000*(ptcl_name.link_sngl_lbd*log(ptcl_name.lkgain00*opt_var/(ptcl_name.lkitf00 + ptcl_name.lknoise00) + 1)/log(2) + (opt_var - ptcl_name.lkpwr00) * sum(ptcl_name.para_pnl))
...
cons = (
{'type': 'ineq',
'fun':lambda opt_var: opt_var - net_name.power_lwr_default},
{'type': 'ineq',
'fun':lambda opt_var: net_name.power_upr_default - opt_var})

########################################################
#                    Optimization
########################################################
def wnos_optimize():
	result = minimize(func, net_name.power_lwr_default, constraints=cons, method='SLSQP', options={'disp': False})
